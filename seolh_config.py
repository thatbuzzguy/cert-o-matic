...
def load(config_obj):
    try:
        ...
        config_obj.data['service_config']['config_file'] = temp_data[
            'service_config']['config_file']
        config_obj.data['service_config']['backend'] = temp_data['service_config']['backend']
        config_obj.data['service_config']['private_key_file'] = temp_data[
            'service_config']['private_key_file']
        config_obj.data['service_config']['private_key_format'] = temp_data[
            'service_config']['private_key_format']
        config_obj.data['service_config']['private_key_password'] = temp_data[
            'service_config']['private_key_password']
        config_obj.data['service_config']['root_certificate_file_name'] = temp_data[
            'service_config']['root_certificate_file_name']
        config_obj.data['service_config']['root_certificate_format'] = temp_data[
            'service_config']['root_certificate_format']
        ...
        config_obj.data['service_config']['port_number'] = temp_data[
            'service_config']['port_number']
        config_obj.data['service_config']['auth_psk'] = temp_data['service_config']['auth_psk']
        config_obj.data['root_cert_config']['common_name'] = temp_data[
            'root_cert_config']['common_name']
        config_obj.data['root_cert_config']['issuer_name'] = temp_data[
            'root_cert_config']['issuer_name']
        config_obj.data['root_cert_config']['subject_alternate_names'] = temp_data[
            'root_cert_config']['subject_alternate_names']
        config_obj.data['root_cert_config']['email_address'] = temp_data[
            'root_cert_config']['email_address']
        config_obj.data['root_cert_config']['organization'] = temp_data[
            'root_cert_config']['organization']
        config_obj.data['root_cert_config']['organizational_unit'] = temp_data[
            'root_cert_config']['organizational_unit']
        config_obj.data['root_cert_config']['city_or_locality'] = temp_data[
            'root_cert_config']['city_or_locality']
        config_obj.data['root_cert_config']['state_or_province'] = temp_data[
            'root_cert_config']['state_or_province']
        config_obj.data['root_cert_config']['country_name'] = temp_data[
            'root_cert_config']['country_name']
        config_obj.data['root_cert_config']['algorithm_name'] = temp_data[
            'root_cert_config']['algorithm_name']
        config_obj.data['root_cert_config'][
            'hash_name'] = temp_data['root_cert_config']['hash_name']
        config_obj.data['root_cert_config']['certificate_lifetime_in_days'] = temp_data[
            'root_cert_config']['certificate_lifetime_in_days']
        config_obj.data['client_cert_config']['email_address'] = temp_data[
            'client_cert_config']['email_address']
        config_obj.data['client_cert_config']['organization'] = temp_data[
            'client_cert_config']['organization']
        config_obj.data['client_cert_config']['organizational_unit'] = temp_data[
            'client_cert_config']['organizational_unit']
        config_obj.data['client_cert_config']['city_or_locality'] = temp_data[
            'client_cert_config']['city_or_locality']
        config_obj.data['client_cert_config']['state_or_province'] = temp_data[
            'client_cert_config']['state_or_province']
        config_obj.data['client_cert_config']['country_name'] = temp_data[
            'client_cert_config']['country_name']
        config_obj.data['client_cert_config']['algorithm_name'] = temp_data[
            'client_cert_config']['algorithm_name']
        config_obj.data['client_cert_config'][
            'hash_name'] = temp_data['client_cert_config']['hash_name']
        config_obj.data['client_cert_config']['certificate_lifetime_in_days'] = temp_data[
            'client_cert_config']['certificate_lifetime_in_days']
